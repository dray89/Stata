...
summarize agem1 weeksm1 samesex morekids 
summarize weeksm1 if weeksm1==0
disp 120141/254654
summarize weeksm1 if weeksm1>0
summarize samesex if morekids==0
summarize morekids
...
Yes; the coefficient is negative. 

b. Now add controls for race and age of the mother. Interpret the coefficient on morekids.

After adding controls, the coefficient becomes more negative. */
...
Because morekids may be correlated with the error term due to missing variables.  
*/
...
a. Estimate a first stage regression of morekids on samesex (as well as the other
regressors we added in part (3).
