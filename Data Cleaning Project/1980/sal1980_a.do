...
insheet using "1980/sal1980_a_data_stata.csv", comma clear
...
label define label_arank 14 "1-month contracts total (sum of lines 8-13)", add 
...
label define label_arank 8 "12-month contracts professors", add
