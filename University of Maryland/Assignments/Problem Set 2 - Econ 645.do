...
xtreg lvio (shall incarc_rate density avginc pop), vce(cluster stateid) fe
di [exp(_b[shall])-1]

xtreg lvio (shall incarc_rate density avginc pop) i.year, fe robust
predict resid_xt_1
gen resid_xt_1_ln = ln(resid_xt_1)
reg resid_xt_1 resid_xt_1_ln

xtreg lvio (shall incarc_rate density avginc pop) year, fe robust
predict resid_xt_2
gen resid_xt_2_ln = ln(resid_xt_2)
reg resid_xt_2 resid_xt_2_ln
