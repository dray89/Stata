...
The -gsort- command sorts the variable 'x'
 in ascending order if written '+x' and 
 descending order if written '-x'.
*/
...
tabstat enrl_tot if county == "Los Angeles", 
...
/* 
(1) Regress student test scores on student 
to teacher ratio
(2) Same regression with robust standard errors
(2) Same regression with robust standard
 errors and the percentage of ESL students
*/
